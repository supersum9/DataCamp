...
# Combination list
combinations_list = [list(x) for x in product(criterion_list, \
    max_feature_list, max_depth_list)]
...
param_grid = {'learning_rate': np.linspace(0.1, 2,150), 'min_samples_leaf': \
    list(range(20,65))}
